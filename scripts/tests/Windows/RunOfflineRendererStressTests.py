...
TARGET_NAME = "LuAudioOfflineRendererStressTests"
VS_DEV_CMD = Path(
...
def main() -> int:
    ...
    try:
        ...
        run(
            f"ctest --test-dir {BUILD_DIR} -R OfflineRendererStressTests "
    ...
    print("LuAudio offline renderer stress tests passed.")
    return 0
