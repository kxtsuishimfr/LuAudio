...
TARGET_NAME = "LuAudioStreamingAudioReaderStressTests"
TEST_FILTER = "StreamingAudioReaderStressTests"
VS_DEV_CMD = Path(
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Build and run LuAudio StreamingAudioReader stress tests."
    )
    parser.add_argument(
        "--build-dir",
        type=Path,
    ...
    print("LuAudio StreamingAudioReader stress tests passed.")
    return 0
